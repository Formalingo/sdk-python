...
if TYPE_CHECKING:
    ...
    from .with_s_get_response import WithSGetResponse
...
class WithSItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[WithSGetResponse]:
        """
        Get a submission status
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[WithSGetResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, WithSGetResponse, error_mapping)
    ...
    @dataclass
    class WithSItemRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
