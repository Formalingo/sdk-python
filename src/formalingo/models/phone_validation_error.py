...
if TYPE_CHECKING:
    from .phone_validation_error_details import PhoneValidationError_details

@dataclass
class PhoneValidationError(APIError, AdditionalDataHolder, Parsable):
    # Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additional_data: dict[str, Any] = field(default_factory=dict)

    # The details property
    details: Optional[PhoneValidationError_details] = None
    # The error property
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "details": lambda n : setattr(self, 'details', n.get_object_value(PhoneValidationError_details)),
