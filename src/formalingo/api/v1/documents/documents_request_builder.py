...
class DocumentsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/documents{?limit*,page*,status*}", path_parameters)
    
    def by_id(self,id: UUID) -> DocumentsItemRequestBuilder:
        """
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[DocumentsRequestBuilderGetQueryParameters]] = None) -> Optional[DocumentsGetResponse]:
        """
        List documents
    ...
    async def post(self,body: MultipartBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[DocumentsPostResponse]:
        """
        ...
        return await self.request_adapter.send_async(request_info, DocumentsPostResponse, None)
