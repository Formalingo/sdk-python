...
if TYPE_CHECKING:
    from .status403_error import Status403Error
    from .status_get_response import StatusGetResponse

class StatusRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/integrations/status
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/integrations/status", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[StatusGetResponse]:
        """
        Returns integration profile counts and ordered profile status for the workspace. Requires the `integrations:read` permission.
