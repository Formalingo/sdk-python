...
if TYPE_CHECKING:
    from .recipient_bulk_create_result_status import RecipientBulkCreateResult_status

@dataclass
class RecipientBulkCreateResult(AdditionalDataHolder, Parsable):
    ...
    # The status property
    status: Optional[RecipientBulkCreateResult_status] = None
    # The token property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RecipientBulkCreateResult:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: RecipientBulkCreateResult
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return RecipientBulkCreateResult()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "status": lambda n : setattr(self, 'status', n.get_enum_value(RecipientBulkCreateResult_status)),
