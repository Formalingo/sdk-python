...
if TYPE_CHECKING:
    from .recipient_update_status import RecipientUpdate_status

@dataclass
class RecipientUpdate(AdditionalDataHolder, Parsable):
    ...
    # The status property
    status: Optional[RecipientUpdate_status] = None
    # The token property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RecipientUpdate:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: RecipientUpdate
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "status": lambda n : setattr(self, 'status', n.get_enum_value(RecipientUpdate_status)),
