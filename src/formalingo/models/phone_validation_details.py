...
if TYPE_CHECKING:
    from .phone_validation_details_code import PhoneValidationDetails_code

@dataclass
class PhoneValidationDetails(AdditionalDataHolder, Parsable):
    # Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additional_data: dict[str, Any] = field(default_factory=dict)

    # Stable phone-normalization failure code.
    code: Optional[PhoneValidationDetails_code] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PhoneValidationDetails:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: PhoneValidationDetails
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return PhoneValidationDetails()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "code": lambda n : setattr(self, 'code', n.get_enum_value(PhoneValidationDetails_code)),
