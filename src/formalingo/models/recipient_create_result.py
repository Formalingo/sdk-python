...
if TYPE_CHECKING:
    from .recipient_create_result_status import RecipientCreateResult_status

@dataclass
class RecipientCreateResult(AdditionalDataHolder, Parsable):
    ...
    # The status property
    status: Optional[RecipientCreateResult_status] = None
    # The token property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RecipientCreateResult:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: RecipientCreateResult
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "plain_password": lambda n : setattr(self, 'plain_password', n.get_str_value()),
            "response_count": lambda n : setattr(self, 'response_count', n.get_float_value()),
            "status": lambda n : setattr(self, 'status', n.get_enum_value(RecipientCreateResult_status)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("plain_password", self.plain_password)
