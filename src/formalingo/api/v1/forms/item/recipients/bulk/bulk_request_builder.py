...
class BulkRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/forms/{id}/recipients/bulk", path_parameters)
    ...
    async def post(self,body: BulkPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[BulkPostResponse]:
        ...
        return await self.request_adapter.send_async(request_info, BulkPostResponse, error_mapping)
    ...
    @dataclass
    class BulkRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
