...
@dataclass
class Document_pageDimensions(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> Document_pageDimensions:
        """
        ...
        return Document_pageDimensions()
