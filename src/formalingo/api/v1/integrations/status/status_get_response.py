...
if TYPE_CHECKING:
    from .status_get_response_data import StatusGetResponse_data
...
class StatusGetResponse(AdditionalDataHolder, Parsable):
    ...
    # The data property
    data: Optional[StatusGetResponse_data] = None
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "data": lambda n : setattr(self, 'data', n.get_object_value(StatusGetResponse_data)),
