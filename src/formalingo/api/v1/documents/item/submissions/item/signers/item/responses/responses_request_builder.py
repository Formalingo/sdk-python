...
if TYPE_CHECKING:
    from ..........models.update_signer_responses_body import UpdateSignerResponsesBody
...
class ResponsesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/documents/{id}/submissions/{sid}/signers/{signerId}/responses", path_parameters)
    ...
    async def patch(self,body: UpdateSignerResponsesBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ResponsesPatchResponse]:
        """
    ...
    def to_patch_request_information(self,body: UpdateSignerResponsesBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update field values for a signer. Returns 409 if any field’s assigned signer has already completed signing.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
