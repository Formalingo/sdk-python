...
if TYPE_CHECKING:
    from .deliveries_get_response_data import DeliveriesGetResponse_data

@dataclass
class DeliveriesGetResponse(AdditionalDataHolder, Parsable):
    # Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additional_data: dict[str, Any] = field(default_factory=dict)

    # The data property
    data: Optional[list[DeliveriesGetResponse_data]] = None
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "data": lambda n : setattr(self, 'data', n.get_collection_of_object_values(DeliveriesGetResponse_data)),
