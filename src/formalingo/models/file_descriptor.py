...
if TYPE_CHECKING:
    from .file_descriptor_authorization import FileDescriptor_authorization
    from .file_descriptor_download_method import FileDescriptor_downloadMethod

@dataclass
class FileDescriptor(AdditionalDataHolder, Parsable):
    # Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additional_data: dict[str, Any] = field(default_factory=dict)

    # The authorization property
    authorization: Optional[FileDescriptor_authorization] = None
    # The contentType property
    content_type: Optional[str] = None
    # The downloadMethod property
    download_method: Optional[FileDescriptor_downloadMethod] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> FileDescriptor:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "authorization": lambda n : setattr(self, 'authorization', n.get_enum_value(FileDescriptor_authorization)),
            "contentType": lambda n : setattr(self, 'content_type', n.get_str_value()),
            "downloadMethod": lambda n : setattr(self, 'download_method', n.get_enum_value(FileDescriptor_downloadMethod)),
